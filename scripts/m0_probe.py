...
import time, hashlib, json, subprocess, os, urllib.request

OLLAMA = "http://localhost:11434/api/generate"
MODEL = "qwen2.5-coder:1.5b"
OPTS = {"seed": 0, "temperature": 0, "num_ctx": 2048, "num_thread": 4, "top_k": 1, "top_p": 1, "num_predict": 256}
PROMPT = (
    "Write a single Python function `load_config(path)` that reads a JSON file "
